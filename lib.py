...
intmod = lambda i: i if i % 1 else int(i)

sin =  lambda string, params, args: repr(intmod(math.sin(math.radians(float(args[0])))))
cos =  lambda string, params, args: repr(intmod(math.cos(math.radians(float(args[0])))))
tan =  lambda string, params, args: repr(intmod(math.tan(math.radians(float(args[0])))))
sinr=  lambda string, params, args: repr(intmod(math.sin(float(args[0]))))
cosr=  lambda string, params, args: repr(intmod(math.cos(float(args[0]))))
tanr=  lambda string, params, args: repr(intmod(math.tan(float(args[0]))))
...
rnd_l= lambda string, params, args: repr(intmod(round(float(args[0]), int(args[1]))))
add =  lambda string, params, args: repr(intmod(float(args[0]) + float(args[1])))
sub =  lambda string, params, args: repr(intmod(float(args[0]) - float(args[1])))
mul =  lambda string, params, args: repr(intmod(float(args[0]) * float(args[1])))
div =  lambda string, params, args: repr(intmod(float(args[0]) / float(args[1])))
pow_l= lambda string, params, args: repr(intmod(float(args[0]) **float(args[1])))
